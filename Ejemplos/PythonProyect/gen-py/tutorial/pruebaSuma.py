...
class Iface:
  def restar(self, number1, number2):
    """
    Parameters:
     - number1
     - number2
  ...
  def sumar(self, number1, number2):
    """
    Parameters:
     - number1
     - number2
...
class Client(Iface):
  ...
  def restar(self, number1, number2):
    ...
    Parameters:
     ...
     - number2
    """
    self.send_restar(number1, number2)
    self.recv_restar()

  def send_restar(self, number1, number2):
  ...
  def sumar(self, number1, number2):
    ...
    Parameters:
     ...
     - number2
    """
    self.send_sumar(number1, number2)
    self.recv_sumar()

  def send_sumar(self, number1, number2):
...
class Processor(Iface, TProcessor):
  ...
  def process_restar(self, seqid, iprot, oprot):
    ...
    result = restar_result()
    try:
      self._handler.restar(args.number1, args.number2)
  ...
  def process_sumar(self, seqid, iprot, oprot):
    ...
    result = sumar_result()
    try:
      self._handler.sumar(args.number1, args.number2)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except Exception as ex:
